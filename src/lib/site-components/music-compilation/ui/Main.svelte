<script lang="ts">
    import { pieces, GroupByStatement, statement_to_field, Tier, type Piece } from "$music-compilation";
    import { group_by_statements } from "$music-compilation-ui/utils.svelte";
    import Accordion from "$ui-utils/Accordion.svelte";
    import Tooltip from "$ui-utils/Tooltip.svelte";
    import Preface from "$music-compilation-ui/preface/Preface.svelte"
    import GroupBy from "$music-compilation-ui/GroupBy.svelte";
    import Title from "$music-compilation-ui/Title.svelte";
