...
const z_x_chapter_1 = T.BookChapter.from_exposition([
    T.Prose.parse(`
...
const z_x_chapter_2 = T.BookChapter.from_exposition([
    T.Prose.parse(`
    ...
    T.Prose.parse(`Proving $$\\langle 2 \\rangle \\subset \\langle \\ 2, \\ 2x^2 + x + 1 \\ \\rangle$$`)
);




const z_x_chapter_3 = T.BookChapter.from_exposition([
    T.Prose.parse(`
...
const z_x_chapter_4 = T.BookChapter.from_exposition([
    T.Prose.parse(`
    ...
    T.Prose.parse(`Proving $$\\langle \\ 2, \\ 4x^2 + 5x + 3 \\ \\rangle \\subset \\langle \\ 2, \\ x + 1 \\ \\rangle$$`)
);



const z_x_chapter_5 = T.BookChapter.from_exposition([
    T.Prose.parse(`
...
export const z_x_chapter = T.BookChapter.from_subchapters({
    introduction: z_x_introduction,
    subchapters: [
        z_x_chapter_1,
        z_x_chapter_2,
        z_x_chapter_3,
    ...
    title: T.Prose.parse(`$$\\mathbb{Z}[x]$$`)
});
