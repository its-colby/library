...
const P2 = new Inline([
    `Based on their similarities and differences, we can group these numbers into different sets. And, in fact, the following sets are so common in mathematics, that they even have their own special symbols.`,
]);
